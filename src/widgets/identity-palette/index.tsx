  ...
  return (
    <>
      ...
      >
        ...
        />
        <Paragraph>
          Процентные значения представляют собой обобщенные показатели
          и&nbsp;отражают усредненное относительное распределение цветов.
          Приведенные значения не следует использовать как абсолютные величины,
          обязательные к&nbsp;применению для каждого отдельного носителя
          и&nbsp;точки контакта.
        </Paragraph>
        ...
        <img
          src={wr.src}
          style={{ marginLeft: `-1.8%`, width: `100%` }}
          alt=''
        />
      </Section>
      <PageToggle
