        ...
        title={
          isMobile ? (
            ...
            <p className={styles.title}>
              ...
              научиться умело использовать обновленный стиль СИБУРа. Отвечайте
              на 20 вопросов, выбирая правильный вариант, и не бойтесь ошибиться
              — к каждому ответу дается пояснение, а сам тренажер можно пройти
        ...
        {isMobile && !started && (
          <>
            <Paragraph style={{ marginTop: 40 }}>
              Мы разработали тренажер, чтобы помочь развить насмотренность и
              научиться умело использовать обновленный стиль СИБУРа.
              <br />
              <br />
              Отвечайте на 20 вопросов, выбирая правильный вариант, и не бойтесь
              ошибиться — к каждому ответу дается пояснение, а сам тренажер
              можно пройти неограниченное количество раз.
            </Paragraph>
            <a
                  ...
                  <p className={styles.resDesc}>
                    {score >= 18 ? (
                      <>
                        ...
                        вы можете регулярно проверять свои знания на тренажере и
